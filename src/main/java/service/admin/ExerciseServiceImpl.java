...
import dao.admin.ExerciseGuideDAO;
import dao.admin.ExerciseGuideDAOImpl;
...
public class ExerciseServiceImpl implements ExerciseService {
	...
	public ExerciseServiceImpl() {
		exerciseGuideDAO = new ExerciseGuideDAOImpl();
	}
	...
	public void registerExerciseGuide(ExerciseDTO dto) throws Exception {
		try {
            ...
            exerciseGuideDAO.insertGuide(dto);
	...
	public Map<String, Object> getExerciseGuideList(int page, String targetMuscle, String searchKeyword) throws Exception {
	    ...
	    // 1. 전체 데이터 개수 조회
	    int totalCount = exerciseGuideDAO.selectGuideCount(params);
	    ...
	    List<ExerciseDTO> list = exerciseGuideDAO.selectAllGuide(params);
	...
	public ExerciseDTO getExerciseDetail(int egNum) throws Exception {
		return exerciseGuideDAO.selectGuideById(egNum);
	}
	
	@Override
	public void modifyExerciseGuide(ExerciseDTO dto) throws Exception {
		int result = exerciseGuideDAO.updateExerciseGuide(dto);
	    if(result == 0) {
	...
	public void removeExerciseGuide(int egNum) throws Exception {
	    ...
	    ExerciseDTO guide = exerciseGuideDAO.selectGuideById(egNum);
	    
	    if (guide != null) {
	        int result = exerciseGuideDAO.deleteGuide(egNum);
