...
<div style="background:white;border-radius:28px;width:100%;max-width:460px;margin:80px 20px 20px;box-shadow:0 24px 80px rgba(0,0,0,0.2);overflow:hidden;animation:fb_modal_in 0.35s ease;">
  ...
  <!-- 폼 -->
  <form action="gymJoin" method="post" enctype="multipart/form-data" style="padding:28px 32px;display:flex;flex-direction:column;gap:18px;">
    ...
    <div style="display:flex;gap:10px;margin-top:4px;">
      <button type="button" onclick="location.href='<%=request.getContextPath()%>/member/login'"
      style="flex:1;padding:13px;border-radius:99px;border:1.5px solid #E8EDF5;background:white;color:#5A6480;font-size:14px;font-weight:700;cursor:pointer;font-family:'Noto Sans KR',sans-serif;transition:all 0.2s;" onmouseover="this.style.background='#F7F9FC'" onmouseout="this.style.background='white'">
        건너뛰기
      </button>
